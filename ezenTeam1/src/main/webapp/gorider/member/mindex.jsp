...
<!--         <style type="text/css">*{border:solid 1px red;}</style> -->
 ...
 <style>
	...
	#menu_wrap {margin:10px 0 30px 10px;padding:5px;overflow-y:auto;background:rgba(255, 255, 255, 0.7);z-index: 1;font-size:12px;border-radius: 10px;}
	...
	#placesList .item h5, #placesList .item .info {text-overflow: ellipsis;overflow: hidden;white-space: nowrap; font-size: 15px;}
...
<div  class="wrap">
   ...
   <div class="mainimg"></div>
	     ...
	     <div class="contentBox">
	        ...
	        <div class="option">
	            <div>
	                <form onsubmit="searchPlaces(); return false;" class="searchbox">
	                    <input type="text"  id="keyword" size="15" class="destination" placeholder="어디로 갈까요?" /> 
	                    <button type="submit" class="searchbtn">GO</button> 
	                </form>
	            </div>
	        </div>
	        <hr>
	        <div class="selectedPlaceInfo" > </div>
